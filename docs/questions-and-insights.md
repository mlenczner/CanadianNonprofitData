...
- Which departments are failing the post-Dec 2025 mandatory fields (riding number, business number)? Are the big spenders the worst offenders?
...
- Are there departments that have never filed a "Nothing to Report" but also have suspiciously few records? Could indicate underreporting.
...
- Are there departments with a disproportionate share of very short descriptions? Who are the worst offenders on boilerplate?
...
## Potential Stories / Outputs

- "The $972 billion black box" — how much federal grant money has inadequate public description
- Department-by-department compliance scorecard
- Riding-level federal generosity map (for the ~20% of records with riding data)
...
- The amendment problem: agreements that have been modified 10+ times
